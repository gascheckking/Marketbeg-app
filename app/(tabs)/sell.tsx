  ...
  return (
    <View style={styles.page}>
      ...
      <Pressable style={styles.card}>
        ...
        <Text style={styles.cardSub}>Många objekt · Paket · AI</Text>
      </Pressable>
      ...
      >
        ...
        <Text style={styles.cardSub}>Direkt byte · Snabb match</Text>
      </Pressable>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  sub: { color: theme.colors.muted, marginBottom: 20 },
  primary: {
  ...
  primaryTitle: { fontSize: theme.text.lg, fontWeight: '900', color: '#000' },
  primarySub: { fontSize: theme.text.sm, color: '#000', opacity: 0.7 },
  card: {
  ...
  cardTitle: { fontWeight: '800', color: theme.colors.text },
  cardSub: { fontSize: theme.text.sm, color: theme.colors.muted },
});