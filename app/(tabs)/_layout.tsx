...
export default function TabsLayout() {
  return (
    ...
    >
        ...
        options={{
          tabBarButton: () => (
            <View style={styles.sellWrap}>
              <Pressable onPress={() => router.push('sell')} style={styles.sellButton}>
      ...
      />
      <Tabs.Screen name="trade" options={{ tabBarIcon: ({ color }) => <Ionicons name="swap-horizontal-outline" size={22} color={color} /> }} />
      <Tabs.Screen name="profile" options={{ tabBarIcon: ({ color }) => <Ionicons name="person-outline" size={22} color={color} /> }} />
    </Tabs>
  );
}
