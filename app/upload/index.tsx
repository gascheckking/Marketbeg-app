...
const styles = StyleSheet.create({
  ...
  title: { fontSize: theme.text.lg, fontWeight: '900', color: theme.colors.text, marginBottom: 16 },
  actions: { gap: 12, marginBottom: 16 },
  primary: { backgroundColor: theme.colors.primary, borderRadius: theme.radius.lg, paddingVertical: 16, alignItems: 'center' },
